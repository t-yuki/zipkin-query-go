...
//go:generate swagger generate server -t ../.. -A Zipkin
...
func main() {
	...
	api := operations.NewZipkinAPI(swaggerSpec)
	...
	fmt.Printf("serving zipkin at http://%s\n", listener.Addr())
	go func() {
	...
	fmt.Printf("serving zipkin at https://%s\n", tlsListener.Addr())
